  ...
  const fetchData = async () => {
    try {
      ...
      const postsUrl = selectedCategory === 'ALL'
        ? `${apiUrl}/posts?room=philo`
        : `${apiUrl}/posts?room=philo&category=${selectedCategory}`;
      ...
      const circlesResponse = await fetch(`${apiUrl}/circles?room=philo`, { credentials: 'include' });
