      ...
      <div className="relative z-20 w-full max-w-md px-4 py-4 mx-auto">
        ...
        <div className="border border-white/10 rounded-lg p-4" style={{ background: 'rgba(0,0,0,0.4)', backdropFilter: 'blur(16px)' }}>
          <form onSubmit={handleSubmit} className="space-y-3">
            <div>
              <label htmlFor="username" className="block text-[0.7rem] tracking-[0.15em] text-white/70 mb-1.5 uppercase font-bold">
                Username
              </label>
              <input
                id="username"
            ...
            {/* Password Field */}
            <div>
              <label htmlFor="password" className="block text-[0.7rem] tracking-[0.15em] text-white/70 mb-1.5 uppercase font-bold">
                Password
              </label>
            ...
            <div className="text-right">
              <Link to="/forgot-password" className="text-[0.65rem] text-white/50 hover:text-white/80 transition-colors tracking-wide">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-3 pt-3 border-t border-white/10 text-center">
            <p className="text-[0.65rem] text-white/40 tracking-wide">
              ...
              <Link to="/register" className="text-white/75 hover:text-white transition-colors uppercase tracking-wider">
                Create One
              </Link>
            </p>
          </div>
