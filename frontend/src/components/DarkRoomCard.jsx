          ...
          <div className="flex gap-3 mb-4 flex-1">
            ...
            <div className="flex-[0_0_75%] overflow-hidden">
              ...
              >
                ...
                <div className="absolute bottom-2 right-2" style={{ width: '20px', height: '20px', borderBottom: '2px solid rgba(239, 68, 68, 0.35)', borderRight: '2px solid rgba(239, 68, 68, 0.35)' }} />
              </div>
            </div>
