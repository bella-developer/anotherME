          ...
          <div className="flex gap-3 mb-5">
            ...
            <div className="flex-[0_0_80%] overflow-hidden">
              ...
              >
                ...
                <div className="absolute top-2 left-2" style={{ width: '16px', height: '16px', borderTop: '2px solid rgba(239, 68, 68, 0.6)', borderLeft: '2px solid rgba(239, 68, 68, 0.6)' }} />
                <div className="absolute top-2 right-2" style={{ width: '16px', height: '16px', borderTop: '2px solid rgba(239, 68, 68, 0.6)', borderRight: '2px solid rgba(239, 68, 68, 0.6)' }} />
                <div className="absolute bottom-2 left-2" style={{ width: '16px', height: '16px', borderBottom: '2px solid rgba(239, 68, 68, 0.6)', borderLeft: '2px solid rgba(239, 68, 68, 0.6)' }} />
                <div className="absolute bottom-2 right-2" style={{ width: '16px', height: '16px', borderBottom: '2px solid rgba(239, 68, 68, 0.6)', borderRight: '2px solid rgba(239, 68, 68, 0.6)' }} />
              </div>
            </div>
