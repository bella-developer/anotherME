          ...
          <div className="flex gap-3 mb-4 flex-1">
            ...
            <div className="flex-[0_0_75%] overflow-hidden">
              ...
              >
                ...
                <div className="absolute top-2 left-2 pointer-events-none" style={{ width: '24px', height: '24px', borderTop: '2.5px solid rgba(168, 85, 247, 0.25)', borderLeft: '2.5px solid rgba(168, 85, 247, 0.25)', opacity: 0.6 }} />
                <div className="absolute top-2 right-2 pointer-events-none" style={{ width: '24px', height: '24px', borderTop: '2.5px solid rgba(168, 85, 247, 0.25)', borderRight: '2.5px solid rgba(168, 85, 247, 0.25)', opacity: 0.6 }} />
                <div className="absolute bottom-2 left-2 pointer-events-none" style={{ width: '24px', height: '24px', borderBottom: '2.5px solid rgba(168, 85, 247, 0.25)', borderLeft: '2.5px solid rgba(168, 85, 247, 0.25)', opacity: 0.6 }} />
                <div className="absolute bottom-2 right-2 pointer-events-none" style={{ width: '24px', height: '24px', borderBottom: '2.5px solid rgba(168, 85, 247, 0.25)', borderRight: '2.5px solid rgba(168, 85, 247, 0.25)', opacity: 0.6 }} />
              </div>
            </div>
